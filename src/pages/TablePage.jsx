...
export default function TablePage() {
  ...
  return (
    <div className="bg-[#E2BBE9] w-full h-screen flex items-center flex-col ">
      <Header className="text-[#444B79]" />
      <div className="bg-white w-[76.5rem] h-[49rem] rounded-[1.125rem] px-[3rem] py-[2rem]">
        <div>
        ...
        <div className="pt-[2rem] flex space-x-4">
          ...
          />
          <Button value="Search" className="bg-[#6C6BAF] text-[1.125rem] text-white font-semibold px-[2rem] rounded-[4px]" onClick={clickHandler}/>
        </div>
      </div>
    </div>
  );
